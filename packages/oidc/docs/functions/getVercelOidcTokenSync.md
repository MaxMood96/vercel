...
Defined in: [packages/oidc/src/get-vercel-oidc-token-sync.ts:25](https://github.com/MaxMood96/vercel/blob/main/packages/oidc/src/get-vercel-oidc-token-sync.ts#L25)
