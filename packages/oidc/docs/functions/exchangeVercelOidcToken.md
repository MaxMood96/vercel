...
Defined in: [packages/oidc/src/exchange-vercel-oidc-token.ts:138](https://github.com/MaxMood96/vercel/blob/main/packages/oidc/src/exchange-vercel-oidc-token.ts#L138)
