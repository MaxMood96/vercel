...
Defined in: [packages/functions/src/oidc/aws-credentials-provider.ts:20](https://github.com/MaxMood96/vercel/blob/main/packages/functions/src/oidc/aws-credentials-provider.ts#L20)
