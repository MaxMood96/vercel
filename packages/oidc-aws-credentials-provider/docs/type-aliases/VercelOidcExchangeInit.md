...
Defined in: [aws-credentials-provider.ts:30](https://github.com/MaxMood96/vercel/blob/main/packages/oidc-aws-credentials-provider/src/aws-credentials-provider.ts#L30)
